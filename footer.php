 ...
 <div class="container"><br>
  <div class="row">
    <div class="col-sm-12 text-center">
      ...
      <div class="copyright">
        <p class="white"> copyright &copy; <b>Chocolate & More | by Charan</b></p>
        <p><i class="fa fa-phone"></i> +00 (123) 456 7890 &nbsp;<i class="fa fa-envelope-o"></i> chocolatemore@domain.com</p>
      </div>
    </div>
  </div>
 </div>
